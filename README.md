...
<details>
<summary><b>После запуска стратегии <code>general*</code> ничего не происходит</b></summary>
<br>

Убедитесь, что во вкладке **«Тестирование»** после запуска статус стал **«Соединение установлено»**.

Если не помогает — напишите:
- Discord: `Jack_Lat`
- Telegram: [@Jack_Lat](https://t.me/Jack_Lat)
...
2. Обновите сборку, если приложение предлагает это сделать
3. При необходимости положите актуальные стратегии в  
   `AppData\Roaming\nasafix\strategies`
...
Стратегии со временем могут переставать работать из-за обнаружения или изменений со стороны провайдера.

Что можно сделать:
- протестировать все доступные стратегии
- выбрать другую рабочую стратегию
- создать новую стратегию на основе существующей

Документация по параметрам: [zapret readme](https://github.com/bol-van/zapret/blob/master/docs/readme.md#nfqws)

</details>

<details>
<summary><b>Как полностью переустановить или обновить NasaFIX</b></summary>
<br>

1. Сохраните свои пользовательские данные, если добавляли что-то вручную
2. Перезагрузите компьютер
3. На вкладке **«Главная»** нажмите **«Выключить»**
4. Перейдите во вкладку **«Тестирование»**
5. Выполните тестирование всех стратегий
6. После нахождения рабочей стратегии включите её через **«Тестирование»** или **«Стратегии»**

</details>

<details>
<summary><b>Не работает игра или приложение с включённым NasaFIX</b></summary>
<br>

Проверьте, что на вкладке **«Главная»** параметр **Game Filter** находится в состоянии **disabled**.

Если он включён, это может влиять на работу игр и приложений, использующих UDP/TCP-порты выше `1023`.

</details>

<details>
<summary><b>После удаления приложения WinDivert остаётся в службах Windows</b></summary>
<br>

Откройте командную строку от имени администратора и выполните:

<pre>
sc stop NasaFIXWinDivert
sc delete NasaFIXWinDivert
</pre>
...
- настроен ли **Secure DNS**
- отключён ли блокировщик рекламы
- протестированы ли другие стратегии

Если раньше работало, а сейчас нет — попробуйте все доступные стратегии заново.

</details>

<details>
<summary><b>Не работает Discord</b></summary>
<br>

Рекомендуется:

1. Сначала определить, на какой стратегии открывается **YouTube**
2. Запустить эту же стратегию
3. Проверить Discord в браузере:  
   https://discord.com/app
4. Если в браузере Discord тоже не работает — проверьте настройку **Secure DNS**
5. После этого попробуйте остальные стратегии

Иногда бывает, что **YouTube работает на одной стратегии, а Discord — нет**.

</details>

<details>
<summary><b>Не нашёл свою проблему</b></summary>
<br>

Создайте issue в репозитории:  
[https://github.com/Jack-Lat/NasaFIX/issues](https://github.com/Jack-Lat/NasaFIX/issues)

Если проблема срочная, можно написать напрямую:
- Discord: `Jack_Lat`
- Telegram: [@Jack_Lat](https://t.me/Jack_Lat)
